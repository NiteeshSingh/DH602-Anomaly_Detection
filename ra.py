"""
Train RA for medical image anomaly Detection 
Author: Cosmin Bercea 
    ...
    def __init__(
        ...
        for ch in channels[1:]:
            self.main.add_module(
                "res_in_{}".format(sz), ResidualBlock(cc, ch, scale=1.0)
            )
...
class RA(nn.Module):
    def __init__(
        ...
        self.encoder = Encoder(
            cdim, zdim, channels, image_size, conditional=conditional, cond_dim=cond_dim
        )
